...
def filter_nearby_vehicles(target_id, target_vehicle, grouped):
    ...
    for timestamp, group in grouped:
        ...
        target_area_vehicles = pd.concat([target_area_vehicles, target_info], ignore_index=True)
        ...
        if not target_info.empty:
            ...
            target_area_vehicles = pd.concat([target_area_vehicles, filtered_group[['vehicle_id', 'timestamp', 'x', 'y']]], ignore_index=True)
